...
export abstract class Viewport {
    ...
    public setTitle(name: string): Viewport { this.title.textContent = name.split(/(?=[A-Z])/).join(" "); return this; }

    public enable(): Viewport { this.enabled = true; return this; }
    public disable(): Viewport { this.enabled = false; return this; }

    public append(element: HTMLElement): Viewport { element.appendChild(this.wrapper); return this; }
    public remove(element: HTMLElement): Viewport { element.removeChild(this.wrapper); return this; }

    public hide(): Viewport { this.wrapper.classList.add("hidden"); return this; }
    public show(): Viewport { this.wrapper.classList.remove("hidden"); return this; }

    public update(): void {}

    protected showAdvise(): Viewport { this.errorMessage.classList.remove("hidden"); return this; }
    protected hideAdvise(): Viewport { this.errorMessage.classList.add("hidden"); return this; }
}

export class Viewport3D extends Viewport implements Loopable {
    ...
    public update(): void {
        ...
        this.app?.update(Time.deltaTime());
...
export class ViewportChart extends Viewport implements Loopable {
